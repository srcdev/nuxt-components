...
describe("LayoutGridByWidth", () => {
  ...
  it("renders as <div> by default", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, { props: { itemCount: 1 } });
  ...
  it("renders no slot content when itemCount is 0", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, { props: { itemCount: 0 } });
  ...
  it("accepts columns as a number (count mode) without error", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 3, columnWidth: "312px" },
    });
    expect(wrapper.vm).toBeTruthy();
  });
  ...
  it("accepts columns as a CSS string (width mode) without error", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 4, columnWidth: "200px" },
    });
    expect(wrapper.vm).toBeTruthy();
  });
  ...
  it("accepts columns as a rem string without error", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 4, columnWidth: "15rem" },
    });
    expect(wrapper.vm).toBeTruthy();
  });
  ...
  it("accepts colWidth without error when columns is a number", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 3, columnWidth: "200px" },
    });
    expect(wrapper.vm).toBeTruthy();
  });
  ...
  it("accepts colWidth without error when columns is a string", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 3, columnWidth: "250px" },
    });
    expect(wrapper.vm).toBeTruthy();
  });
  ...
  it("does not render the dev warning when colWidth is not set", async () => {
    const wrapper = await mountSuspended(LayoutGridByWidth, {
      props: { itemCount: 2, columnWidth: "300px" },
    });
